export const hero = [
  {
    id: 1,
    cover: "../images/hero/k.jpg",
    catgeory: "featured",
    title: "Pernah Dengar Kata Cosplay ? Berikut Penjelasannya",
    authorName: "Kirei",
    authorImg: "../images/author.jpg",
    time: "18 Feb 2023",
    desc: [
      {
        para1: "Jika kamu penggemar komik asal Jepang, pasti sudah tidak asing dengan istiah cosplay. Kegiatan cosplay ini berkembang dengan pesat sampai ke berbagai negara, termasuk ke Indonesia. Cosplay sendiri merujuk pada hobi berkostum ala karakter animasi, komik maupun video games.",
      },
      {
        para2: "Cosplay sendiri merujuk pada hobi berkostum ala karakter animasi, komik maupun video games. Cosplay merupakan gabungan dari kata Costum dan Play, Jadi, jika disimpulkan cosplay diartikan sebagai kegiatan bermain kostum.",
      },
      {
        para3: "Orang yang melakukannya disebut sebagai cosplayer. Mengutip dari BBC, cosplayer bukan hanya meniru busana atau kostum dari karakter tertentu, namun mereka juga berdandan dan menggunakan aksesoris yang menyerupai karakter tertentu tersebut. Bahkan, sikap dan pose pun sama persis dengan karakternya",
      },
      {
        para4: "Padahal cosplay tidak terbatas hanya pada anime, bila kamu menyukai animasi Disney bahkan Superhero Marvel, kamu juga bisa mengikuti cosplay.",
      },
      {
        para5: "Di Indonesia cosplayer masih didominasi dengan karakter anime, sehingga tidak banyak orang yang tahu, bahwa cosplayer karakter diluar anime pun cukup banyak peminatnya.",
      },
    ],
    details: [
      {
        title: "AWAL MULA COSPLAY?",
      },
      { para1: "Pada awalnya cosplay tidak begitu di kenal di Indonesia. Sekitar awal tahun 2000-an, Universitas Indonesia mengadakan event cosplay dalam gelar Jepang UI. Tetapi saat itu belum ada peminatnya." },
      {
        quote: "“YOU’RE NEVER TOO OLD TO COSPLAY!“ ~COWBUTT CRUNCHIES COSPLAY",
      },
      {
        para2: "Tidak berselang lama, Muda mudi di Bandung memperkenalkan gaya Harajuku Jepang. Lambat laun cosplay pun di kenal hingga sekarang.",
      },
      {
        para3: "Tetapi dalam berapa tahun belakangan ini, kepopuleran dan minat hobi cosplay meningkat di kalangan anak muda Indonesia. Terutama pasca pandemic Covid 19, mayoritas anak muda mencari kegiatan untuk menghilangkan jenuh karena berada di rumah terlalu lama. ",
      },
      {
        para3: "Kepopuleran hobi cosplay ditandai oleh meningkatnya angka pengunjung pada event event cosplay dimanapun juga, terutama di kota kota besar.",
      },
      {
        para3: "Ditambah beberapa selebriti Indonesia seperti Aura Kasih, Azka Corbuzier, Al Ghazali, Anya Geraldine, Kevin Aprilio dan lainnya, pernah menggunakan kostum cosplay.",
      },
      {
        para3: "Semua kalangan tentu saja bisa menjadi cosplayer, tidak terbatas oleh usia, gender dan latar belakang. Dari yang hanya sekedar hobi sampai yang menekuninya sebagai profesi. ",
      },
      {
        para3: "Inilah sedikit penjelasan tentang COSPLAY",
      },
    ],
  },
  {
